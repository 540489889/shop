      ...
      <div class="d-w-mall">
        <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-width="80px" class="demo-ruleForm">
          ...
          <el-form-item class="subBox">
            <el-button class="add-address" type="primary" @click="submitForm('ruleForm2')">修改地址</el-button>
          </el-form-item>
        </el-form>
  ...
  export default {
    ...
    methods: {
      getEdit(){
        ...
        axios.get('/Home/Person/edit',{
          params: {
            id: this.$route.query.id
          }
        })
          .then(this.getEditSucc)
      },
      getEditSucc(res){
        const data = res.data.data
        this.ruleForm2.manName = data.name
        this.ruleForm2.manTell = data.tel
        this.ruleForm2.city = data.address[0]+' '+data.address[1]+' '+data.address[2]
        this.ruleForm2.xxCity = data.address[3]
        this.ruleForm2.address.province = data.address[0]
        this.ruleForm2.address.city = data.address[1]
        this.ruleForm2.address.district = data.address[2]
